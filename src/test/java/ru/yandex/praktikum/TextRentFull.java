...
import static ru.yandex.praktikum.OrderPageScooter.*;
    ...
    public class TextRentFull {
        ...
        public TextRentFull(String name, String surname, String address, String metro, String phone, String date, String rentalPeriod, String colour, String comment) {
            this.name = name;
